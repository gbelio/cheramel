  ...
  <div class="col-xs-12 col-md-12 col-lg-12 formulario login">
      <form class="form" action="" method="POST">
        ...
        <div class="form-groups">
          <input type="email" class="form-control" name="email" value="<?=isset($errores["email"])? "": inputUsuario("email");?>" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Ingresar correo">
        </div>
        <br>
